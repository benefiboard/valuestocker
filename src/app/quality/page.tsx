            ...
            >
              ...
              <div className="md:hidden border-t border-gray-100 p-4">
                <div className="space-y-4">
                  ...
                  {/* ROE 필터 섹션 */}
                  <div className="pb-3 border-b border-gray-100">
                    <h3 className="text-sm font-medium text-gray-700 mb-2">ROE 필터</h3>
                  ...
                  {/* 영업이익률 필터 섹션 */}
                  <div className="pb-3 border-b border-gray-100">
                    <h3 className="text-sm font-medium text-gray-700 mb-2">영업이익률 필터</h3>
                    <div className="flex flex-col space-y-2">
                      <div className="flex items-center">
                        <span className="w-10 text-xs text-gray-500">최소:</span>
                        <input
                    ...
                    <thead className="bg-gradient-to-r from-gray-50 to-gray-100">
                      <tr>
                        ...
                        >
                          <div className="flex items-center whitespace-nowrap">
                            이익률(%)
                            {renderSortIcon('avg_operating_margin')}
                          </div>
                        </th>
                        <th
                          scope="col"

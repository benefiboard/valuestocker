  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      <main className="flex-1 w-full">
        {/* 히어로 섹션 */}
        <div className="w-full py-12 md:py-24 px-6 md:px-12 flex flex-col items-center text-center bg-gradient-to-b from-white to-emerald-50">
        ...
        {/* 주요 기능 섹션 */}
        <div className="w-full py-12 md:py-24 px-6 md:px-12 bg-white">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="my-6 md:my-12">
              <div className="text-center mb-8">
                <h3 className="text-2xl md:text-3xl  font-bold text-gray-800">대가들의 전략</h3>
            ...
            <div className="mt-6 md:mt-12">
              <div className="text-center mb-8">
                <h3 className="text-2xl md:text-3xl font-bold text-gray-800">실용투자 전략</h3>

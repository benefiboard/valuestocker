...
import { useUrlFilters, srimPageSchema, SrimPageFilters } from '@/hooks/useUrlFilters';
...
export default function SrimPage() {
  ...
  useEffect(() => {
    ...
    // 정렬 적용
    filtered.sort((a, b) => {
      const valueA = a[filters.sortField as keyof SrimStock];
      const valueB = b[filters.sortField as keyof SrimStock];

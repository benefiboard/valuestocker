...
export default function LynchPage() {
  ...
  const renderSortIcon = (field: SortField) => {
    ...
    return sortDirection === 'asc' ? (
      <ArrowUp size={12} className="ml-1 text-green-600 sort-icon" />
    ) : (
      <ArrowDown size={12} className="ml-1 text-green-600 sort-icon" />
    );
  };
        ...
        <div className="bg-white bg-opacity-90 backdrop-blur-md shadow-sm rounded-2xl p-4 flex items-center">
          ...
          <h1 className="text-xl sm:text-2xl font-bold text-gray-800 flex items-center">
            <div className="p-2 bg-green-50 rounded-full mr-3">
              <BarChart4 className="text-green-600 w-5 h-5 sm:w-6 sm:h-6" />
            </div>
            피터 린치 PEG 기반 종목
          </h1>
        </div>
            ...
            <div className={`accordion-content ${isConditionExpanded ? 'open' : ''}`}>
              <div className="p-4 sm:p-5 pt-0 border-t border-gray-100">
                ...
                <ul className="list-disc pl-5 text-sm sm:text-base text-gray-700 space-y-2">
                  <li>
                    <strong className="text-green-700">PEG 비율</strong> - PER를 EPS 성장률로 나눈
                    값으로, 성장성 대비 주가의 적정성을 판단
                  </li>
                  <li>
                    <strong className="text-green-700">적정 PEG = 1.0</strong> - 피터 린치는 PEG가
                    1.0 이하인 주식을 매력적으로 평가
                  </li>
                  <li>
                    <strong className="text-green-700">산업별 PEG 적용</strong> - 각 산업별 특성에
                    맞는 적정 PEG 비율 적용
                  </li>
                  <li>
                    <strong className="text-green-700">적정주가 계산</strong> - EPS × 성장률 × 산업
                    적정 PEG = 적정 PER → EPS × 적정 PER = 적정주가
                  </li>
                  <li>
                    <strong className="text-green-700">최소 30% 안전마진</strong> - PEG 기반
                    적정주가 대비 30% 이상 저평가된 종목만 표시
                  </li>
                  <li>
                    <strong className="text-green-700">성장률 기반 투자</strong> - 합리적인 가격에서
                    높은 성장성을 가진 기업 선별
                  </li>
                  <li>
                    <strong className="text-green-700">연속 배당 여부 표시</strong> - 3년
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
                  ...
                  <div className="filter-section">
                    ...
                    <select
                      ...
                      className="filter-select w-full border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200"
                    >
                  ...
                  <div className="filter-section">
                    ...
                    <div className="flex space-x-2">
                      <input
                        ...
                        min="0"
                        step="1"
                        className="filter-input w-full border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200"
                      />
                  ...
                  <div className="filter-section">
                    ...
                    <div className="flex space-x-2">
                      <select
                        ...
                        className="filter-select flex-1 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200"
                      >
              ...
              <div className="p-4 sm:p-5 border-b border-gray-200">
                <div className="flex justify-between items-center">
                  <h2 className="text-lg sm:text-xl font-semibold text-gray-800 flex items-center">
                    ...
                    <span className="ml-2 text-sm font-normal bg-green-50 text-green-700 px-2 py-0.5 rounded-full">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {currentItems.map((stock) => (
                        ...
                        >
                          ...
                          <td className="bg-gray-50 px-3 py-3 whitespace-nowrap">
                            <div className="text-xs font-semibold text-green-600 bg-green-50 px-1 py-0.5 rounded">
                          ...
                          <td className="bg-gray-50 px-3 py-3 whitespace-nowrap text-center">
                            {stock.consecutive_dividend ? (
                              <div className="inline-flex items-center justify-center bg-green-50 w-5 h-5 rounded-full">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {currentItems.map((stock) => (
                        ...
                        >
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="text-sm font-semibold text-green-600 bg-green-50 px-2 py-1 rounded-lg inline-block">
                              {formatNumber(stock.peg_price)}원
                            </div>
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="text-sm font-semibold text-green-600 bg-green-50 px-2 py-1 rounded-lg inline-block text-center">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-center">
                            {stock.consecutive_dividend ? (
                              <div className="inline-flex items-center justify-center bg-green-50 w-7 h-7 rounded-full">
                              ...
                              <button
                                ...
                                className={`relative inline-flex items-center px-4 py-2 border text-sm font-medium transition-colors duration-200 ${
                                  currentPage === pageNumber
                                    ? 'z-10 bg-green-50 border-green-500 text-green-600 hover:bg-green-100'

...
import { useUrlFilters, profitPageSchema, ProfitPageFilters } from '@/hooks/useUrlFilters';
...
export default function ProfitPage() {
  ...
  } = useUrlFilters(profitPageSchema);
  ...
  useEffect(() => {
    ...
    // 정렬 적용
    filtered.sort((a, b) => {
      const valueA = a[filters.sortField as keyof ProfitStock];
      const valueB = b[filters.sortField as keyof ProfitStock];
